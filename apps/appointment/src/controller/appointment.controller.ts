...
export class AppointmentController {
  ...
  @MessagePattern('appointment.getAllWithFilter')
  async getAllWithFilter(@Payload() data: FilterAppointmentDto) {
    return this.appointmentService.getAllWithFilter(data);
  }
}
